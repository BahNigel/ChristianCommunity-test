					...
					<div class="container">
						<div class="inside">
							<div class="nav nav-tab menu">
								<button class="btn"><img class="avatar-xl" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-male-1.jpg') }}" alt="avatar"></button>
						...
						<div class="col-md-12">
							<div class="tab-content">
								...
								<div id="notifications" class="tab-pane fade">
									...
									<div class="notifications">
										...
										<div class="list-group" id="alerts" role="tablist">
											...
											<a href="#" class="filterNotifications all latest notification" data-toggle="list">
												<img class="avatar-md" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-female-3.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
												<div class="status">
													<i class="material-icons online">fiber_manual_record</i>
												</div>
												<div class="data">
											...
											<a href="#" class="filterNotifications all oldest notification" data-toggle="list">
												<img class="avatar-md" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-female-5.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
												<div class="status">
													<i class="material-icons offline">fiber_manual_record</i>
												</div>
												<div class="data">
											...
											<a href="#" class="filterNotifications all oldest notification" data-toggle="list">
												<img class="avatar-md" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-female-2.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
												<div class="status">
													<i class="material-icons offline">fiber_manual_record</i>
												</div>
												<div class="data">
											...
											<a href="#" class="filterNotifications all oldest notification" data-toggle="list">
												<img class="avatar-md" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-male-3.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
												<div class="status">
													<i class="material-icons offline">fiber_manual_record</i>
												</div>
												<div class="data">
											...
											<a href="#" class="filterNotifications all oldest notification" data-toggle="list">
												<img class="avatar-md" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-male-4.jpg') }}" data-toggle="tooltip" data-placement="top" title="Janette" alt="avatar">
												<div class="status">
													<i class="material-icons offline">fiber_manual_record</i>
												</div>
												<div class="data">
								...
								<div class="tab-pane fade" id="settings">
									<div class="settings">
										<div class="profile">
											<img class="avatar-xl" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-male-1.jpg') }}" alt="avatar">
										...
										<div class="categories" id="accordionSettings">
											...
											<div class="category">
												...
												<div class="collapse" id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionSettings">
													<div class="content">
														<div class="upload">
															<div class="data">
																<img class="avatar-xl" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-male-1.jpg') }}" alt="image">
																<label>
																	<input type="file">
											...
											<div class="category">
												...
												<div class="collapse" id="collapseFour" aria-labelledby="headingFour" data-parent="#accordionSettings">
													<div class="content">
														<div class="app">
															<img src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/integrations/slack.svg') }}" alt="app">
														...
														<div class="app">
															<img src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/integrations/dropbox.svg') }}" alt="app">
															<div class="permissions">
																<h5>Dropbox</h5>
														...
														<div class="app">
															<img src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/integrations/drive.svg') }}" alt="app">
															<div class="permissions">
																<h5>Google Drive</h5>
														...
														<div class="app">
															<img src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/integrations/trello.svg') }}" alt="app">
															<div class="permissions">
																<h5>Trello</h5>
																<p>No permissions set</p>
															</div>
								...
								<form>
									<div class="form-group">
										...
										<div class="user" id="contact">
											<img class="avatar-sm" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-female-5.jpg') }}" alt="avatar">
											<h5>Keith Morris</h5>
											...
											<div class="inside">
												<div class="panel">
													<div class="participant">
														<img class="avatar-xxl" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-female-5.jpg') }}" alt="avatar">
							...
							<div class="chat" id="chat2">
								<div class="top">
									<div class="container">
										<div class="col-md-12">
											<div class="inside">
												<a href="#"><img class="avatar-md" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-female-2.jpg') }}" data-toggle="tooltip" data-placement="top" title="Lean" alt="avatar"></a>
												<div class="status">
													<i class="material-icons offline">fiber_manual_record</i>
												</div>
												<div class="data">
							...
							<div class="chat" id="chat3">
								<div class="top">
									<div class="container">
										<div class="col-md-12">
											<div class="inside">
												<a href="#"><img class="avatar-md" src="{{ url('/public/assets' . env('USE_MINIFIED') . '/Frontend/img/avatars/avatar-female-6.jpg') }}" data-toggle="tooltip" data-placement="top" title="Louis" alt="avatar"></a>
												<div class="status">
													<i class="material-icons offline">fiber_manual_record</i>
												</div>
												<div class="data">
